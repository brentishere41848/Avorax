      ...
      <div className="container">
        ...
        <div className="mx-auto mt-12 max-w-4xl">
          {layers.map((layer, index) => (
            <div key={layer} className="mb-3 grid grid-cols-[72px_1fr] items-center gap-4 rounded-3xl border border-[#DDE7F2] bg-white p-4 shadow-sm">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-[#5A6678]">Part of the prevention and review pipeline.</p>
              </div>
            </div>
          ))}
        </div>

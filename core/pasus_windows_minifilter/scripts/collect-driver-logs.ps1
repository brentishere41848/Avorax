...
"`n=== PasusAvFilter service ===" | Add-Content -LiteralPath $OutputPath
sc.exe query PasusAvFilter 2>&1 | Add-Content -LiteralPath $OutputPath
"`n=== Recent System Events ===" | Add-Content -LiteralPath $OutputPath
Get-WinEvent -LogName System -MaxEvents 100 |
  Where-Object { $_.ProviderName -match "Service Control Manager|FilterManager|Pasus" } |

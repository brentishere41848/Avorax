...
| Checkpoint 2196 regression evidence | Prove catalog support reduces false-positive risk without weakening scan, UI, package, or safety contracts | Definitive local and exact implementation-head CI/packages verified; evidence-head/merge pending | Post-review Native passes `445 + 6`, standard workspace `1,489`, all-features workspace `1,490`, Flutter `838/838`, source contracts `626/626`, and strict lint/format/analyzer/security/dependency gates pass. Final central verification and independent validation pass exactly `225/225` in `577.2s`; stale `224` evidence is rejected and the protected vault is unchanged. Implementation `3eb079cce859b3523dcb22c983ba81628900f9c5` passes CI `32586661770` and package push/PR runs `32586651615`/`32586661643` across Windows, Linux, both macOS architectures, checksums, and lockfile SBOM, with publication skipped. Evidence-head CI/packages, merge, merged-main checks, and original-tree synchronization remain pending. |

...
| Checkpoint 2191 regression evidence | Prove the root change does not regress process observation, scan, quarantine, update, UI, or resource gates | Local and hosted implementation-head full-suite/package evidence verified; evidence head and installed behavior pending | Process skip and system-directory filters pass `3/3` each, process watch `1/1`, collection `14/14`, Guard `244/244`, workspace `1,476/1,476`, source contracts `626/626`, strict Guard Clippy, rustfmt, parser checks, and release build. The central report passes `220/220` in `545.5s`; its validator passes in `1.6s`. Commit `67e067d2d74d7561c4a48269284702ca50f1b1a1` passes CI `32366912857` and Desktop Packages push/PR `32366882138`/`32366913124`; publish is skipped. Three release watches, including a spoofed child environment, return the intended fail-visible coverage result. `Cargo.lock` and the existing ProgramData vault are unchanged. |

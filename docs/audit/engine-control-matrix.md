...
| Checkpoint 2190 verification and package regression | Prove the native collector does not regress shared engines, UI, security gates, or desktop package construction | Local and hosted verified; release/install intentionally absent | Focused collection passes `14/14`, Guard `239/239`, workspace `1,471/1,471`, source contracts `626/626`, and central verification `220/220` in `687.6s`. Exact implementation head `a928aa0297cadeedd002a4e84cf937250de6bf3b` passes CI `32356686816`; Ubuntu job `96387285689` passes `process_collection` `9/9`. Package runs `32356656322` and `32356686469` pass Windows/Linux/macOS plus consolidation; publish jobs are skipped. `Cargo.lock` is unchanged. |

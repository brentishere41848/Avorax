...
| Checkpoint 2193 hosted regression | Prove the changed shell path on real macOS arm64/x64 runners and guard all other desktop packages | Exact implementation head verified; merge and installed behavior pending | Commit `07e803c42880e7bc556642e206828f4e5c33b815` is on draft PR `#45`; CI `32484140638` passes. Package push/PR runs `32484112523`/`32484140672` pass contracts, Windows, Linux, macOS arm64/x64, and consolidation jobs `96780217485`/`96780488329`. Publish jobs `96780340949`/`96780547410` are skipped. No package was installed. |

...
if ($RequireFullSuite) {
  ...
  Assert-ReportScopeContains $verifiedScopeText "Guard process enumeration coverage gaps are bounded, fail-visible, and cannot become a clean finite-watch result" "verification_scope.verified"

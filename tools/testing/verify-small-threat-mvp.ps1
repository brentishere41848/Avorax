...
$technicalLimits += " Non-archive static cancellation is cooperative, not preemptive: one already-running UTF-8 or UTF-16 lossy/lowercase normalization or one term search can complete before the next checkpoint. Input remains bounded by the existing 64 MiB sample cap."
